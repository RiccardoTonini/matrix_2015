...
def lin_comb_mat_vec_mult(M, v):
    ...
    mat_dict = mat2coldict(M)
    return sum([v[x] * mat_dict[x] for x in M.D[1]])
...
def lin_comb_vec_mat_mult(v, M):
    ...
    '''
    assert(v.D == M.D[0])
    mat_dict = mat2rowdict(M)
    return sum([v[x] * mat_dict[x] for x in M.D[0]])
...
def dot_product_mat_vec_mult(M, v):
    ...
    assert(M.D[1] == v.D)
    mat_dict = mat2rowdict(M)
    return Vec(M.D[0], {x:v * mat_dict[x] for x in M.D[0]})
...
def dot_product_vec_mat_mult(v, M):
    ...
    assert(v.D == M.D[0])
    mat_dict = mat2coldict(M)
    return Vec(M.D[1], {x: v * mat_dict[x] for x in M.D[1]})
...
def Mv_mat_mat_mult(A, B):
  assert A.D[1] == B.D[0]
  mat_dict = mat2coldict(B)
  return coldict2mat({x: A * mat_dict[x] for x in B.D[1]})
...
def vM_mat_mat_mult(A, B):
    assert A.D[1] == B.D[0]
    mat_dict = mat2rowdict(A)
    return rowdict2mat({x:mat_dict[x] * B for x in A.D[0]})
...
#residual
r1 =  Vec({(7, 8), (7, 3), (4, 7), (1, 3), (8, 4), (4, 8), (3, 0), (2, 8), (5, 6), (6, 6), (8, 0), (7, 7), (0, 7), (2, 1), (6, 2), (1, 6), (3, 7), (0, 3), (2, 5), (5, 1), (8, 5), (5, 8), (4, 0), (1, 2), (7, 2), (6, 7), (3, 3), (5, 5), (8, 1), (7, 6), (4, 4), (6, 3), (1, 5), (3, 6), (0, 4), (2, 2), (5, 0), (8, 6), (4, 1), (1, 1), (6, 4), (3, 2), (0, 0), (2, 6), (5, 4), (8, 2), (7, 1), (4, 5), (6, 0), (1, 4), (7, 5), (0, 5), (2, 3), (8, 7), (4, 2), (1, 0), (0, 8), (6, 5), (3, 5), (0, 1), (2, 7), (5, 3), (8, 3), (7, 0), (4, 6), (6, 8), (6, 1), (3, 1), (5, 7), (3, 8), (0, 6), (1, 8), (2, 0), (7, 4), (8, 8), (4, 3), (1, 7), (3, 4), (0, 2), (2, 4), (5, 2)},{(7, 3): 0, (4, 7): 0, (1, 3): 0, (4, 8): 0, (3, 0): 0, (2, 8): 0, (8, 0): 0, (7, 7): 0, (0, 7): 0, (5, 6): 0, (6, 2): 0, (1, 6): 0, (5, 1): 0, (3, 7): 0, (0, 3): 0, (8, 5): 0, (2, 5): 0, (5, 8): 0, (4, 0): 0, (1, 2): 0, (7, 4): 0, (3, 1): 0, (6, 7): 0, (3, 3): 0, (2, 0): 0, (8, 1): 0, (7, 6): 0, (6, 6): 0, (4, 4): 0, (6, 3): 0, (1, 5): 0, (7, 2): 0, (5, 0): 0, (2, 2): 0, (8, 6): 0, (3, 5): 0, (4, 1): 0, (1, 1): 0, (6, 4): 0, (3, 2): 0, (0, 0): 0, (3, 6): 0, (2, 7): 0, (7, 1): 0, (4, 5): 0, (0, 4): 0, (6, 0): 0, (1, 4): 0, (7, 5): 0, (0, 5): 0, (2, 1): 0, (8,