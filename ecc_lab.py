...
from vec import Vec
from mat import Mat
from bitutil import bits2mat, str2bits, noise, bits2mat
from GF2 import one
from matutil import mat2coldict, listlist2mat, coldict2mat
...
def find_error(syndrome):
    ...
    Examples:
        ...
        True
    """
    mat_dict = mat2coldict(H)
    for t in H.D[1]:
        if mat_dict[t] == syndrome:
