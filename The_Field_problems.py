...
def myFilter(L, num):
    ...
    Examples:
      ...
      [15, 25]
    '''
    return [n for n in L if num > 0 and n % num]
...
complex_addition_b = (0 + 1j)  # (−1+2i)+(1−1i)
complex_addition_c = (-1 + 0.001j)  # (2+0i)+(−3+.001i)
complex_addition_d = (0.001 + 9j)  # 4(0+2i)+(.001+1i)
